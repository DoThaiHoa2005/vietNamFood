-- ============================================================
-- CẬP NHẬT DỮ LIỆU QUÁN ĂN PHỐ ẨM THỰC VĨNH KHÁNH
-- ============================================================
-- Xóa dữ liệu cũ và thêm 12 quán ăn thực tế trên phố Vĩnh Khánh
-- Quận 4 (cũ), TP.HCM
-- ============================================================
...
-- ============================================================
-- THÊM 12 QUÁN ĂN PHỐ VĨNH KHÁNH
-- ============================================================

-- 1. Alo Quán – Seafood & Beer
INSERT INTO Foods (Name, City, Category, Description_VI, Description_EN, Description_CN, Latitude, Longitude, Rating, ImagePath, Radius, Priority) VALUES
...
10.759012, 106.702156, 4.5, NULL, 30.0, 8);
...
10.759234, 106.702389, 4.6, NULL, 30.0, 8);
...
10.759456, 106.702612, 4.7, NULL, 30.0, 7);
...
10.759678, 106.702835, 4.5, NULL, 30.0, 7);
...
10.759890, 106.703058, 4.6, NULL, 30.0, 8);
...
10.760112, 106.703281, 4.7, NULL, 30.0, 8);
...
10.760334, 106.703504, 4.6, NULL, 30.0, 7);
...
10.760556, 106.703727, 4.8, NULL, 30.0, 9);
...
10.760778, 106.703950, 4.7, NULL, 30.0, 8);
...
10.761000, 106.704173, 4.6, NULL, 30.0, 7);
...
10.761222, 106.704396, 4.7, NULL, 30.0, 8);
...
10.761444, 106.704619, 4.8, NULL, 30.0, 9);

-- ============================================================
-- HOÀN THÀNH
-- ============================================================
SELECT '✅ Đã cập nhật 12 quán ăn phố Vĩnh Khánh thành công!' AS Status;
