...
-- BẮT ĐẦU TỪ 0: Chưa quét QR, chưa cài app, chưa đăng nhập
...
10.78024, 106.70532, 4.8, '/Assets/Images/Q1.jpg', 30.0, 9, NULL, 'Chào mừng bạn đến với Alo Quán – Seafood & Beer, địa chỉ nhậu ngon – bổ – rẻ với hải sản tươi ngon.', 5),
...
10.78156, 106.70614, 4.7, '/Assets/Images/Q2.jpg', 35.0, 8, NULL, 'Chào mừng bạn đến với Ốc Đào 2, nơi có hơn 30 loài ốc được chế biến thành những món ăn độc đáo.', 5),
...
10.78289, 106.70478, 4.6, '/Assets/Images/Q3.jpg', 30.0, 7, NULL, 'Chào mừng bạn đến với Bún cá Châu Đốc Dì Tư, nơi có bún cá với nước dùng thơm ngon chuẩn vị.', 5),
...
10.78412, 106.70321, 4.5, '/Assets/Images/Q4.jpg', 30.0, 7, NULL, 'Chào mừng bạn đến với Bún thịt nướng Cô Nga, nơi có bún thịt nướng Sài Gòn đầy đủ và ngon miệng.', 5),
...
10.78567, 106.70189, 4.6, '/Assets/Images/Q5.jpg', 35.0, 8, NULL, 'Chào mừng bạn đến với Ốc Vũ, địa điểm ăn vặt nổi tiếng với món ốc ngon và nước chấm chua cay độc đáo.', 5),
...
10.78741, 106.70067, 4.7, '/Assets/Images/Q6.jpg', 30.0, 8, NULL, 'Chào mừng bạn đến với Lãng Quán, địa chỉ ăn khuya quen thuộc với menu đa dạng hải sản.', 5),
...
10.78895, 106.69945, 4.7, '/Assets/Images/Q7.jpg', 30.0, 8, NULL, 'Chào mừng bạn đến với Ớt Xiêm Quán, nơi có các món hải sản được chế biến tinh tế và đậm đà.', 5),
...
10.79024, 106.69823, 4.8, '/Assets/Images/Q8.jpg', 35.0, 9, NULL, 'Chào mừng bạn đến với Lẩu nướng HongKong A FAT, nơi có không gian rộng rãi và đa dạng món lẩu nướng.', 5),
...
10.79156, 106.69701, 4.6, '/Assets/Images/Q9.jpg', 30.0, 7, NULL, 'Chào mừng bạn đến với Sườn Muối Ớt, nơi có không gian đẹp và đồ ăn ngon với giá hợp lý.', 5),
...
10.79289, 106.69579, 4.7, '/Assets/Images/Q10.jpg', 30.0, 8, NULL, 'Chào mừng bạn đến với Chilli Quán, nơi có các món nướng ngon với giá phải chăng.', 5),
...
10.79412, 106.69457, 4.8, '/Assets/Images/Q11.jpg', 35.0, 9, NULL, 'Chào mừng bạn đến với Thảo ốc quận 4 cũ, nơi có các món ốc best-seller với hương vị đậm đà.', 5),
...
10.79567, 106.69335, 4.9, '/Assets/Images/Q12.jpg', 35.0, 9, NULL, 'Chào mừng bạn đến với Ốc Oanh, quán ốc ngon nổi tiếng 20 năm với giá cả hợp lý.', 5);
...
SELECT CONCAT('📱 QR Scanned: ', COUNT(*), ' người dùng (bắt đầu từ 0)') AS Info FROM Users WHERE QRScanned = TRUE;
SELECT CONCAT('📲 App Installed: ', COUNT(*), ' người dùng (bắt đầu từ 0)') AS Info FROM Users WHERE AppInstalled = TRUE;
